...
# 1. Prepare gene list from res_ow_nw and run GSEA for over_weight_vs_normal_weight
gene_list_ov_nw <- prepare_entrez_from_ensembl(res_ow_nw)
run_gsea_entrez_sets(gene_list_ov_nw, "over_weight_vs_normal_weight")

# 2. Prepare gene list from res_ob_nw and run GSEA for obese_vs_normal_weight
gene_list_ob_nw <- prepare_entrez_from_ensembl(res_ob_nw)
run_gsea_entrez_sets(gene_list_ob_nw, "obese_vs_normal_weight")

# 3. Prepare gene list from res_ob_ow and run GSEA for obese_vs_over_weight
gene_list_ob_ow <- prepare_entrez_from_ensembl(res_ob_ow)
